...
`Timetable` interface comes from the [`unilim` package](https://js.unilim.docs.literate.ink/interfaces/iut_cs_timetable.timetable).
...
| Command | Description |
| ------- | ----------- |
| `bun dev` | Starts the development server on [`localhost:3000`](http://localhost:3000/). |
