 ...
 */
export const DBTimetable = (year: TimetableYear) => {
  switch (year) {
    case TimetableYear.A1: return DBTimetableA1;
    case TimetableYear.A2: return DBTimetableA2;
    case TimetableYear.A3: return DBTimetableA3;
  }
};
